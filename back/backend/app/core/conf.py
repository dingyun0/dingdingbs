...
class SettingsClass(BaseSettings):
    ...
    UVICORN_PORT: int = 9005
    UVICORN_RELOAD: bool = True

    # DB
    DB_AUTO_GENERATE_SCHEMAS: bool = False  # 自动创建表
    DB_ECHO: bool = False
    DB_DATABASE: str = 'dingdingbs'
    ...
    TOKEN_URL_SWAGGER: str = "/login"
    TOKEN_EXPIRE_MINUTES: int = 60 * 24 * 3  # 3天
    ...
    OPENAI_BASE_MODEL: str = 'xxx'

    # chroma configs
    CHROMA_SERVER_AUTH_CREDENTIALS: str = 'xxx'
    CHROMA_SERVER_AUTH_CREDENTIALS_FILE: str = 'xxx'
    HOST: str = 'xxx'
    PORT: str = 'xxx'
